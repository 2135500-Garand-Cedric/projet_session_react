...
return (
    ...
    <Grid container component="main" sx={{ height: '87vh', width: '90vw' }}>
        ...
        >
            ...
            <FormattedMessage id="authentification.titre" defaultMessage="S'authentifier au gestionnaire d'étudiants"/>
            </Typography>
            <Box
            component="form"
            noValidate
            ...
            <Button
                ...
                sx={{ mt: 3, mb: 2 }}
            >
                <FormattedMessage id="onglet.authentification" defaultMessage="S'authentifier"/>
            </Button>
            <Copyright sx={{ mt: 5 }} />
            </Box>
        </Box>
